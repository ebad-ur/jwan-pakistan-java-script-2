...
var userInput = 123;
var allLower = String(userInput).toLowerCase();
...
var userInput = 123;
var allLower = String(userInput).toUpperCase();
...
const existingVariable = "Hello World";
...
var number = 4.7; // Example initialization
